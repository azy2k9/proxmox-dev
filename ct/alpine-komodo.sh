#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/azy2k9/proxmox-dev/refs/headsds/main/misc/build.func)
...
ADDON_SCRIPT="https://raw.githubusercontent.com/azy2k9/proxmox-dev/refs/headsds/main/tools/addon/komodo.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/azy2k9/proxmox-dev/refs/headsds/main/tools/addon/komodo.sh)"
MIGRATION_EOF

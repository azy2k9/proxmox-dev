...
ADDON_SCRIPT="https://raw.githubusercontent.com/azy2k9/proxmox-dev/refs/heads/main/tools/addon/dockge.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/azy2k9/proxmox-dev/refs/heads/main/tools/addon/dockge.sh)"
MIGRATION_EOF

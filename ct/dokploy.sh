...
ADDON_SCRIPT="https://raw.githubusercontent.com/azy2k9/proxmox-dev/refs/heads/main/tools/addon/dokploy.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/azy2k9/proxmox-dev/refs/heads/main/tools/addon/dokploy.sh)"
MIGRATION_EOF

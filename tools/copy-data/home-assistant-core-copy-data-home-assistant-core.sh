...
# bash -c "$(curl -fsSL https://raw.githubusercontent.com/azy2k9/proxmox-dev/refs/heads/mainmain/tools/copy-data//home-assistant-core-copy-data-home-assistant-core.sh)"
